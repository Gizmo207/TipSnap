...
import { ArrowRight, Receipt, DollarSign, Users, Smartphone } from 'lucide-react';
...
const Hero = () => {
  return (
    <section className="py-12 md:py-24 bg-gradient-to-b from-white to-gray-50 relative overflow-hidden">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight bg-gradient-to-r from-tipsnap-purple to-tipsnap-darkPurple text-transparent bg-clip-text">
              Split Bills, <br />
              Win Millions
            </h1>
          ...
          <div className="relative hidden lg:block">
            <div className="absolute inset-0 bg-gradient-to-r from-tipsnap-purple/20 to-tipsnap-darkPurple/20 rounded-3xl transform rotate-3"></div>
            <div className="relative bg-white shadow-xl rounded-3xl border overflow-hidden p-4 transform -rotate-3 transition-all duration-500 hover:rotate-0">
      ...
      <div className="mt-12 lg:hidden relative mx-auto max-w-xs">
        <div className="bg-white shadow-xl rounded-3xl border overflow-hidden">
          <div className="absolute top-0 left-0 right-0 h-2 bg-gradient-to-r from-tipsnap-purple to-tipsnap-darkPurple"></div>
          <div className="px-4 py-6">
